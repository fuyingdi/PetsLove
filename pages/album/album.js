...
Page({
            ...
            wx.uploadFile({
              ...
              success: function (uploadRes) {
                ...
                if (uploadRes.type == "error") {
                  ...
                  var obj = {src:tempFilePaths[i],notChoosed:true}
                  that.data.myPhotos.push(obj)
                  that.setData({
                    myPhotos:that.data.myPhotos
                  })
  ...
  test: function () {
    // wx.downloadFile({
    //   url:"http://www.wangwei2000.cn:8080/petlove_source/avatar/1.jpg",
    //   success:function(res){
